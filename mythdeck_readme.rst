...
This is documentation for the "MythDeck" configuration to be used with "Myth II: Soulblighter" on the Steam Deck. I've included a bit of info on how to set up and play Myth, but the main point here is to describe how the Steam Deck controls will work.
...
* Add Myth 2 to Steam as a "non-Steam game" shortcut. Give that shortcut the name "Myth II: Soulblighter". You *must* use that specific name in order for this configuration to be available for you on Steam.

* Select the game that you added and open the controller settings. In the community input configurations, select the "MythDeck" config.
